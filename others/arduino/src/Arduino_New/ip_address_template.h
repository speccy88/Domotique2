...
//Disable unused functions to free up some memory on your Arduino project
  #define enable_digital      //1% memory use - TESTED WORKING
  //#define enable_analogin     //0% memory use - TESTED WORKING
  //#define enable_analogout    //1% memory use - TESTED WORKING
  //#define enable_frequency    //1% memory use - TESTED WORKING
  //#define enable_tone         //4% memory use
  //#define enable_temp         //14% memory use - TESTED WORKING
